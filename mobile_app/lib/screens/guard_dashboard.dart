  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text('Connection Error', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
                            const SizedBox(height: 8),
                            const Text(
                              'Ensure your app core/api.dart uses your computer\'s IP address.',
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Manual Entry Mode'))),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(v.visitorName, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
                      Text('Flat ${v.flatId} • ${v.purpose}', style: const TextStyle(color: Color(0xFF64748B), fontSize: 13, fontWeight: FontWeight.w500)),
                    ],
                  ),
                ),
